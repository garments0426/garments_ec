    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女')], default='male', max_length=6, verbose_name='性別')),
                ('mobile', models.CharField(max_length=10, verbose_name='手機')),
                ('e_mail', models.CharField(blank=True, max_length=50, null=True, verbose_name='信箱')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否刪除')),
